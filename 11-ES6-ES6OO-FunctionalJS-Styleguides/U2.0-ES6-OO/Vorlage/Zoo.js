...
food.push({name: "beef", amount : 10, amountPerDelivery : 10, isMeat : true });
food.push({name: "chicken", amount : 10, amountPerDelivery : 10, isMeat : true });
...
Animal.prototype.toString = function () {
    return (this.isDead ? "RIP " : '') + this.name + "[" + this.constructor.name + "]" + (this.foodRequired() ? " -hungry" : "");
};
